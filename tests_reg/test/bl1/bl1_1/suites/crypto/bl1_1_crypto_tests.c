...
/* LMS Test Vector (hsslms) */

/* LMS parameter   : LMS_SHA256_M32_H10 */
/* LMOTS parameter : LMOTS_SHA256_N32_W8 */

static const uint8_t lms_message[23] = {
  0x4C, 0x4D, 0x53, 0x20, 0x74, 0x65, 0x73, 0x74, 0x20, 0x76, 0x65, 0x63, 0x74, 0x6F, 0x72, 0x20,
  0x6D, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65
};
#define LMS_MESSAGE_LEN 23

static uint8_t lms_public_key[56] = {
  0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x04, 0x2B, 0x30, 0x0D, 0x38, 0x90, 0x5C, 0xF9, 0x09,
  0xC4, 0x71, 0x98, 0x1E, 0x97, 0xD5, 0x2A, 0x81, 0xBF, 0x6B, 0x5B, 0xE4, 0xD1, 0xA0, 0xFD, 0x00,
  0xCE, 0x0A, 0x8C, 0x82, 0x03, 0xA1, 0xBE, 0x95, 0x34, 0xB5, 0x1E, 0x00, 0x4B, 0x47, 0x51, 0x87,
  0xB4, 0x1B, 0x78, 0x68, 0xA3, 0x3B, 0x76, 0xCD
};
#define LMS_PUBLIC_KEY_LEN 56

/* Secret key export not available from hsslms; skipping lms_secret_key[] */

static const uint8_t lms_signature[1452] = {
  
};

static const uint8_t lms_invalid_signature[1452] = {
  ,
...
#define LMS_SIGNATURE_LEN 1452

/* Verification result: VALID */

static void tfm_bl1_crypto_test_2017(struct test_result_t *ret)
{
    uint32_t fih_rc;
    FIH_CALL(pq_crypto_verify, fih_rc, lms_public_key, LMS_PUBLIC_KEY_LEN,
             lms_message, LMS_MESSAGE_LEN, lms_signature, LMS_SIGNATURE_LEN);
    if (FIH_NOT_EQ(fih_rc, FIH_SUCCESS)) {
        TEST_FAIL("LMS valid signature verification failed");
        return;
    }

    FIH_CALL(pq_crypto_verify, fih_rc, lms_public_key, LMS_PUBLIC_KEY_LEN,
             lms_message, LMS_MESSAGE_LEN, lms_invalid_signature, LMS_SIGNATURE_LEN);
    if (FIH_EQ(fih_rc, FIH_SUCCESS)) {
        TEST_FAIL("LMS invalid signature verification failed");
        return;
    }
